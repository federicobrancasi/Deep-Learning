...
\colorlet{myorange}{orange!70!red!70!black}
...
\begin{tikzpicture}[x=1.6cm,y=1.1cm]
  ...
  \node[right=19,above=3,align=center,myorange!60!black,font=\bfseries] at (3.1,1.8) {Convolutional\\[-0.2em]Layers};
  \node[above=3,align=center,myblue!60!black,font=\bfseries] at (6.5,1.9) {Fully-Connected\\[-0.2em]Hidden Layers};
  ...
  % LABELS
  \node[above=3,align=center,mygreen!60!black,font=\bfseries] at (N1-1.90) {Input\\[-0.2em]Layer};
  \node[above=3,align=center,myred!60!black,font=\bfseries] at (N\Nnodlen-1.90) {Output\\[-0.2em]Layer};
