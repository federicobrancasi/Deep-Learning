...
\begin{scope}[local bounding box=diagram1]
    \node[fill=myblue!20] (o11) {};
    \node[fill=myblue!20, right=of o11] (o12) {};
    \node[fill=myblue!20, right=of o12] (o13) {};
    \node[fill=mygreen!20, below=of o11] (h11) {};
    \node[fill=mygreen!20, right=of h11] (h12) {};
    \node[fill=mygreen!20, right=of h12] (h13) {};
    \node[fill=myred!20, below=of h11] (i11) {};
...
\begin{scope}[local bounding box=diagram2, xshift=4cm]
    ...
    \node[fill=myblue!20, right=of o22] (o23) {};
    \node[fill=mygreen!20, below=of o21] (h21) {};
    \node[fill=mygreen!20, right=of h21] (h22) {};
    \node[fill=mygreen!20, right=of h22] (h23) {};
    \node[fill=myred!20, below=of h21] (i21) {};
    \node[fill=myred!20, below=of h22] (i22) {};
    \node[fill=myred!20, below=of h23] (i23) {};
...
\begin{scope}[local bounding box=diagram3, xshift=8cm]
    ...
    \node[fill=myblue!20, right=of o32] (o33) {};
    \node[fill=myblue!20, right=of o33] (o34) {};
    \node[fill=myblue!20, right=of o34] (o35) {};
    \node[fill=mygreen!20, below=of o31] (h31) {};
    \node[fill=mygreen!20, right=of h31] (h32) {};
    \node[fill=mygreen!20, right=of h32] (h33) {};
    \node[fill=mygreen!20, right=of h33] (h34) {};
    \node[fill=mygreen!20, right=of h34] (h35) {};
    \node[fill=myred!20, below=of h31] (i31) {};
    \node[fill=myred!20, below=of h32] (i32) {};
    \node[fill=myred!20, below=of h33] (i33) {};
...
\begin{scope}[local bounding box=diagram4, xshift=14.1cm]
    \node[fill=myblue!20] (o41) {};
    \node[fill=myblue!20, right=of o41] (o42) {};
    \node[fill=myblue!20, right=of o42] (o43) {};
    \node[fill=mygreen!20, below=of o41] (h41) {};
    \node[fill=mygreen!20, right=of h41] (h42) {};
    \node[fill=mygreen!20, right=of h42] (h43) {};
    \node[fill=myred!20, below=of h41] (i41) {};
    \node[fill=myred!20, below=of h42] (i42) {};
    \node[fill=myred!20, below=of h43] (i43) {};
