...
\node[font=\bfseries,text width=2.500000cm, align=center] at (1.250000,-0.450000) {Input \vspace{-0.05cm} \linebreak Embedding};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,-0.450000) {Output \vspace{-0.05cm} \linebreak Embedding};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (1.250000,3.430000) {Add \& Norm};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (1.250000,2.580000) {Multi-Head \vspace{-0.05cm} \linebreak Attention};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,6.380000) {Add \& Norm};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,5.530000) {Multi-Head \vspace{-0.05cm} \linebreak Attention};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,3.830000) {Add \& Norm};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,2.780000) {Masked \vspace{-0.05cm} \linebreak Multi-Head \vspace{-0.05cm} \linebreak Attention};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (1.250000,5.980000) {Add \& Norm};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (1.250000,5.130000) {Feed \vspace{-0.05cm} \linebreak Forward};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,8.930000) {Add \& Norm};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,8.080000) {Feed \vspace{-0.05cm} \linebreak Forward};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,10.030000) {Linear};
...
\node[font=\bfseries,text width=2.500000cm, align=center] at (5.250000,11.130000) {Softmax};
...
\node[font=\bfseries,text width=2.500000cm, anchor=north, align=center] at (1.250000,-1.500000) {Inputs};
\node[font=\bfseries,text width=2.500000cm, anchor=north, align=center] at (5.250000,-1.500000) {Outputs \vspace{-0.05cm} \linebreak (shifted right)};
\node[font=\bfseries,text width=2.500000cm, anchor=south, align=center] at (5.250000,11.980000) {Output \vspace{-0.05cm} \linebreak Probabilities};
\node[font=\bfseries,anchor=east] at (-1.175000,3.880000) {$N\times$};
\node[font=\bfseries,anchor=west] at (7.675000,5.355000) {$N\times$};
\node[font=\bfseries,text width=2.000000cm, anchor=east] at (0.250000,0.600000) {Positional \vspace{-0.05cm} \linebreak Encoding};
\node[font=\bfseries,text width=2.000000cm, anchor=west] at (6.750000,0.600000) {Positional \vspace{-0.05cm} \linebreak Encoding};
\end{tikzpicture}
\end{document}